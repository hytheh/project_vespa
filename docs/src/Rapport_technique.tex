...
Nomenclature du prototype mk.2, \textbf{telle que réellement montée}. Total relevé
$\approx$ \textbf{830~\euro{}} TTC (le prix des cartes ST n'a pas été consigné).
...
\textbf{NUCLEO-G431RB} \textit{\footnotesize (MCU du \fichier{motion\_node})} & 1 & --- \\
\textbf{X-NUCLEO-IHM16M1} (STSPIN830) \textit{\footnotesize (étages de puissance)} & 2 & --- \\
