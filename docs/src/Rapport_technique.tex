...
|  \- references/         Articles, datasheets, etudes prep., rapport mk.1
|- hardware/
...
\- software/
   |- common/             Protocole CAN partage (C, portable STM32/ESP32)
...
\textbf{Bus CAN — persistance} & \textcolor{vespared}{\textbf{\emph{Overlay} absent de
\fichier{/boot}}} — à réinstaller & — \\
